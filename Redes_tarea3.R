...
##                                                        ##
## Autor: Elena Cortés Tapias & Mercedes Brenes Álvarez   ##
## Email: elena.cortes.t@gmail.com; mebreal@gmail.com     ##
## Fecha: Enero 2020                                      ##
############################################################
...
## partir de datos de ChIP-seq y suponen un refinameinto de la redes de co-expresión 
## génica. 
...
## vamos a trabajar solo con la red inducida que contiene los factores de transcripción
...
## Uno de los primeros análisis que se realizan sobre redes transcripcionales es la 
## búsqueda de subgrafos o patrones no aleatorios. Estos subgrafos se denominan 
## motivos de red.
## Formalmente, un motivo de red es un subgrafo que aparece un número significativamente
## de veces mayor en la red de interés que en redes aleatorias que cumplen las 
## mismas propiedades.

## Primero, realizamos un análisis rápido para comprobar que esta red inducida
...
## red de interés son las generadas según el modelo de Erdos-Renyi. La función
## erdos.renyi.game genera redes aleatorias que siguen una distribución de Poisson
...
## Para ver el número de genes autorregulados en una red basta con sumar los
...
## Para comprobar la signficancia de la autorregulación generamos 1000 redes
## aleatorias y calculamos el número de autorregulaciones en cada una almacenándola
## en un vector.
...
## (en la actualidad solo puede recibir tamaños 3 o 4) y devuelve el número de
