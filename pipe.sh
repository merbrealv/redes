...
while [ $I -le $NUMCHIP ]
do
   qsub -N chip$I -o $WD/logs/chip$I /home/elme/tarea/chip_processing.sh $I $WD $NUMCHIP $NUMSAM $PROMOTER $OUTPUT $SAMPLEDIR
   ((I++))
...
while [ $I -le $NUMINPUT ]
   do
   qsub -N input$I -o $WD/logs/input$I /home/elme/tarea/input_processing.sh $I $WD $NUMINPUT $NUMSAM $PROMOTER $OUPUT $SAMPLEDIR
   ((I++))
done
